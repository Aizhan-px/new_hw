...
export function Clock() {
  ...
  const stringTime =  date.toLocaleTimeString('en-US')|| <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) //'date->time' пишут студенты
  const stringDate = date.toLocaleDateString('en-US')|| <br/> // день.месяц.год (01.02.2022) //'date->date'
